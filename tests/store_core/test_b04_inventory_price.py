...
class B04Tests(unittest.TestCase):
    def test_inventory_rejects_negative_or_naive(self):  # B04-01
    ...
    def test_display_rounding_cannot_approve_below_ten_percent(self):  # B04-02
    ...
    def test_price_inputs_fail_closed(self):  # B04-03
