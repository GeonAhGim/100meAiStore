...
| Next local commit | Single-receipt synthetic return review and exact-ID completion reconciliation | 205 Python tests; compileall/diff/pattern/filename checks |
